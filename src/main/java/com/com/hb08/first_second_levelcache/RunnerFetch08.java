...
public class RunnerFetch08 {
    ...
    public static void main(String[] args) {
        ...
        //First level cache is related with the same session
        //even if you are in the same session, If you want to get students that have difference id, Hibernate create two queries
